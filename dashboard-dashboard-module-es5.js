...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
  ...
  function srcAppAddEmployeeAddEmployeeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _utility_http_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../utility/http.service */
    "./src/app/utility/http.service.ts");

    var AddEmployeeComponent = /*#__PURE__*/function () {
      function AddEmployeeComponent(service, router, title, toaster) {
      ...
      _createClass(AddEmployeeComponent, [{
        ...
        value: function onSubmit(f) {
          ...
          this.service.addEmployee(obj).subscribe(function (response) {
            _this2.toaster.success(response, "Employee Added"); // this.jsonObj.addedMessage = response;
            ...
            if (error.status != 0) {
              ...
              _this2.toaster.error(error.status + " " + error.error, "Error...!!!");
            } else {
              alert(error.message);

              _this2.toaster.error(error.message, "Error...!!!");
            }
          });
        }
      }]);
  ...
  function srcAppDashboardDashboardRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _employee_details_employee_details_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var _utility_auth_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../utility/auth.guard */
    ...
    var routes = [{
      ...
      canActivate: [_utility_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
    }, {
      path: "empDetails/:id",
      component: _employee_details_employee_details_component__WEBPACK_IMPORTED_MODULE_4__["EmployeeDetailsComponent"],
      canActivate: [_utility_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
    }, {
      path: "addEmployee",
  ...
  function srcAppDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _utility_filter_pipe__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../utility/filter.pipe */
    ...
    DashboardModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_home_home_component__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_5__["HeaderComponent"], _employee_details_employee_details_component__WEBPACK_IMPORTED_MODULE_6__["EmployeeDetailsComponent"], _add_employee_add_employee_component__WEBPACK_IMPORTED_MODULE_7__["AddEmployeeComponent"], _update_employee_update_employee_component__WEBPACK_IMPORTED_MODULE_8__["UpdateEmployeeComponent"], _utility_filter_pipe__WEBPACK_IMPORTED_MODULE_9__["FilterPipe"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["DashboardRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_11__["NgxPaginationModule"], _utility_material_module__WEBPACK_IMPORTED_MODULE_12__["MaterialModule"]]
    })], DashboardModule);
    /***/
  },
  ...
  function srcAppEmployeeDetailsEmployeeDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EmployeeDetailsComponent = /*#__PURE__*/function () {
      function EmployeeDetailsComponent(route, service, title, modalService) {
      ...
      _createClass(EmployeeDetailsComponent, [{
        ...
        key: "getEmpDataFromUrl",
        value: function getEmpDataFromUrl() {
          var _this3 = this;

          this.route.paramMap.subscribe(function (param) {
            _this3.getEmpDataOnId(param.get('id'));
          });
        }
      }, {
        key: "getEmpDataOnId",
        value: function getEmpDataOnId(id) {
          var _this4 = this;

          this.service.getEmployeeOnId(id).subscribe(function (response) {
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _utility_dialog_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../utility/dialog.service */
    "./src/app/utility/dialog.service.ts");
    /* harmony import */


    var _utility_http_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../utility/http.service */
    "./src/app/utility/http.service.ts");

    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(service, title, modalService, dialogServie, route, toaster) {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          this.getAllEmployee();
          this.title.setTitle("Admin | Home"); // this.getDataFromAddEmp();
        } // getDataFromAddEmp(){
        ...
        value: function onDelete() {
          ...
          if (this.isSelected) {
            this.dialogServie.openConfirmDialog("Are you sure you want to delete this record?").afterClosed().subscribe(function (res) {
              console.log(res);

              if (res) {
                _this5.service.deleteEmployee(_this5.empObj.id).subscribe(function (response) {
                  _this5.toaster.success(response, "Record Deleted");

                  _this5.getAllEmployee();
                }, function (myError) {
                  // alert("Something went wrong");
                  _this5.toaster.error("Something went wrong", "Error");
                });
              }
            });
          } else {
          ...
          if (this.isSelected) {
            if (this.empObj.status == 'Active') {
              ...
              this.service.updateEmployee(this.empObj).subscribe(function (response) {
                _this6.toaster.success(_this6.empObj.name + " 's status changed Successfully...!!!", "Status changed...!!!");

                _this6.getAllEmployee();
              }, function (myError) {
                _this6.toaster.error("Something went wrong...!!!", "Error...!!!");
              });
  ...
  function srcAppUpdateEmployeeUpdateEmployeeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UpdateEmployeeComponent = /*#__PURE__*/function () {
      function UpdateEmployeeComponent(service, title, toaster) {
      ...
      _createClass(UpdateEmployeeComponent, [{
        ...
        value: function onUpdate() {
          ...
          this.service.updateEmployee(this.empDateFromHome).subscribe(function (response) {
            _this8.isSubmitted = false;
            _this8.backendResponse = response;

            _this8.service.getAllEmployee();

            _this8.toaster.success(response, "Record Updated...!!!");
          }, function (myError) {
            // alert("Something went wrong...!!!");
            _this8.toaster.error("Something went wrong...!!!", "Error...!!!");
          });
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], UpdateEmployeeComponent.prototype, "empDateFromHome", void 0);
  ...
  /***/
  function srcAppUtilityAuthGuardTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUtilityDialogServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUtilityFilterPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
